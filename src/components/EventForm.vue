        ...
        <div class="modal-wrapper">
            <div class="modal-container">
                ...
                <b-row v-if="method == 1">
                    ...
                    <b-col sm="10">
                        <b-form-input v-model="id" type="number" trim></b-form-input>
                    </b-col>
                </b-row>
                ...
                <b-row v-if="method != 2 && method != 3">
                    ...
                    <b-col sm="10">
                        <b-form-input v-model="title" trim autofocus></b-form-input>
                    </b-col>
                </b-row>
                ...
                <b-row v-if="method != 1">
                    ...
                    <b-col sm="10">
                        <b-form-input v-model="phase" trim></b-form-input>
                    </b-col>
                </b-row>
                ...
                <b-row v-if="method != 1">
                    ...
                    <b-col sm="10">
                        <b-form-input v-model="mileage" type="number"></b-form-input>
                    </b-col>
                </b-row>
                ...
                <b-row v-if="method != 1">
                    ...
                    <b-col sm="10">
                        <b-form-input v-model="tolls" trim type="number"></b-form-input>
                    </b-col>
                </b-row>
                ...
                <b-row>
                    ...
                    <b-col sm="4">
                        <button class="btn btn-primary" v-if="method == 1 || method == 2" type="button"
                ...
                if (this.method == 0) {
                    ...
                    for (i = 0; i < this.events.length; i++) {
                        if (this.events[i].title == this.title) {
                            this.totalTime += Math.abs(new Date(this.events[i].end) - new Date(this.events[i].start)) /
                                36e5;
                        }
                    }
